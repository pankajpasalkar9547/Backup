...
public class AnimalTypeServiceServiceLocator extends org.apache.axis.client.Service implements com.webserviseclasses.AnimalTypeServiceService {
    ...
    public com.webserviseclasses.AnimalTypeService getAnimalTypeService() throws javax.xml.rpc.ServiceException {
    ...
    public com.webserviseclasses.AnimalTypeService getAnimalTypeService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webserviseclasses.AnimalTypeServiceSoapBindingStub _stub = new com.webserviseclasses.AnimalTypeServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webserviseclasses.AnimalTypeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webserviseclasses.AnimalTypeServiceSoapBindingStub _stub = new com.webserviseclasses.AnimalTypeServiceSoapBindingStub(new java.net.URL(AnimalTypeService_address), this);
                _stub.setPortName(getAnimalTypeServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webserviseclasses.com", "AnimalTypeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webserviseclasses.com", "AnimalTypeService"));
        }
