...
<jsp:useBean id="sampleAnimalTypeServiceProxyid" scope="session" class="com.webserviseclasses.AnimalTypeServiceProxy" />
<%
...
case 10:
        gotMethod = true;
        com.webserviseclasses.AnimalTypeService getAnimalTypeService10mtemp = sampleAnimalTypeServiceProxyid.getAnimalTypeService();
